...
public class SQLPatternFactory
{
    ...
    public static class SPF
    {
        ...
        /**
         * Creates a repetition of the given SQL pattern part, within the specified minimum and maximum occurrence limits.
         *
         * @param minCount the minimum number of times the pattern should appear; must be a non-negative integer
         * @param maxCount the maximum number of times the pattern can appear; can be null for an unlimited maximum,
         *                 but if specified, must be greater than or equal to {@code minCount} and greater than zero
         * @param part the {@link SQLPatternPart} to repeat
         * @return a new {@link SQLPatternPart} wrapper containing the repetition constraints for the specified pattern part
         */
